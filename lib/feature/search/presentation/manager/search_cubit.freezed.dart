...
mixin _$SearchState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(SearchResult searchResult) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(SearchResult searchResult)? success,
...
class _$SuccessImpl<T> implements Success<T> {
  const _$SuccessImpl(this.searchResult);
  ...
  @override
  String toString() {
    return 'SearchState<$T>.success(searchResult: $searchResult)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return success?.call(searchResult);
  }
...
abstract class Success<T> implements SearchState<T> {
  const factory Success(final SearchResult searchResult) = _$SuccessImpl<T>;
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'SearchState<$T>.error(errorMessage: $errorMessage)';
  }
